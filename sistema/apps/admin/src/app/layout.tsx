...
export default function LayoutPainel({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR" data-app="painel" className={`${fraunces.variable} ${poppins.variable} ${baloo.variable}`}>
      <body className="min-h-dvh bg-papel font-texto text-tinta antialiased">
        ...
        <header>
          <div className="border-b-2 border-tinta bg-papel">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-2">
              <Image src="/marca/logo.webp" alt="T-shirt Club.br" width={96} height={66} priority className="h-11 w-auto" />
              <span className="tc-sobretitulo text-tinta">Painel da loja</span>
            </div>
          </div>
